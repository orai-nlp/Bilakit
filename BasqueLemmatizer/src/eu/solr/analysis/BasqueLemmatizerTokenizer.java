...
public final class BasqueLemmatizerTokenizer extends Tokenizer {
    private static BasqueLemmatizer euslem = new BasqueLemmatizer();
    ...
    public static String processReader(Reader reader){
        ...
        String lemmatized_text = euslem.getLemma(text);
   ...
   */
  public BasqueLemmatizerTokenizer(Reader input) {
   ...
   */
  @Deprecated
  public BasqueLemmatizerTokenizer(Version matchVersion, Reader input) {
    super(input);
    init(matchVersion);
  }
   ...
   */
  public BasqueLemmatizerTokenizer(AttributeFactory factory, Reader input) {
   ...
   */
  @Deprecated
  public BasqueLemmatizerTokenizer(Version matchVersion, AttributeFactory factory, Reader input) {
    super(factory, input);
    init(matchVersion);
  }
  ...
  public final boolean incrementToken() throws IOException {
    ...
    while(true) {
      ...
      if (scanner.yylength() <= maxTokenLength) {
        ...
        // remain.
        if (tokenType == BasqueLemmatizerTokenizer.ACRONYM_DEP) {
          typeAtt.setType(BasqueLemmatizerTokenizer.TOKEN_TYPES[BasqueLemmatizerTokenizer.HOST]);
          termAtt.setLength(termAtt.length() - 1); // remove extra '.'
        } else {
          typeAtt.setType(BasqueLemmatizerTokenizer.TOKEN_TYPES[tokenType]);
        }
        return true;
      } else
